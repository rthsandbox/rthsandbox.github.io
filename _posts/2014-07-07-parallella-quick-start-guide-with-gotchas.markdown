...
---
{% img center /images/parallella_screenshot.png Parallella screenshot, 1080p. %}
...
{% img right /images/parallella.jpg Parallella. 18 cores on a tiny board. %}
###Tools Required
...
{% img right /images/parallella_fan.jpg Bits get hot. Use a fan. %}
...
{% img middle /images/dd_progress.png Activity Monitor %}
...
{% img right /images/eject_boot.png Eject the SD card. %}
